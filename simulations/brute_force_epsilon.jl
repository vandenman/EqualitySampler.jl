...
# function brute_force_ϵ(model; dummy_draws = 200, max_attempts = 25, kwargs...)

# 	wcLogger = WarningCountingLogger()

# 	# power = 4
# 	initial_ϵ = 0.0#1 / 2^power

# 	powers = range(-1, stop = -8, length = max_attempts)
...
# 		wcLogger.count < 10 && validate_rhat(samps, 1.1) && break
# 		wcLogger.count = 0
# 		# power += 1
# 		# initial_ϵ = 1 / 2^power
# 	end
# 	@info "found an ϵ of " initial_ϵ powers[i] i
