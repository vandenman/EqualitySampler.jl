...
@testset "anova_test" begin
	...
	@test isapprox(true_θ, estimated_θ_full; atol = 0.1)
	@test isapprox(true_θ, estimated_θ_eqs; atol = 0.1)
	...
	@test isapprox(obs_offset, estimated_θ_full; atol = 0.1)
	@test isapprox(obs_offset, estimated_θ_eqs; atol = 0.1)
