...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{figures/simulation_results_test_clean_figures/simulation_manuscript.pdf}
    \caption{The left figure shows the , whereas the right figure shows the posterior means with a Beta-binomial prior over the partitions with $\alpha = 8$ and $\Beta = 1$.}}
